...
export default function Transfer() {
  ...
  const extrinsicColumns = [
    ...
    },
    {
      ...
      width: 100,
      render: (text: any, record: any) => {
        return <Normal state={record.data.feeFrozen ? record.data.feeFrozen : '-'} />
      },
    ...
    },
    {
      ...
      width: 100,
      render: (text: any, record: any) => {
        return <Normal state={record.data.free ? record.data.free : '-'} />
      },
      sorter: (a: any, b: any) => {
  ...
  return <ChainxTable Columns={extrinsicColumns} urlControl={'/ChainTable?'} result={'items'} keyNum={4} />
}
