  ...
  const chainColumns = [
    {
      ...
      render: (text: any, record: any) => {
        return <LinkX linkUrl={`/blockDetails/${record[0]}`} state={record[0]} content={record[0]} />
      },
    },
    {
      title: t('Vote Count'),
      ...
      key: 'address',
      render: (text: any, record: any) => {
        return <Normal state={record[1].data[1] ? record[1].data[1] : '-'} />
      },
    },
    {
      title: t('Vote Count'),
      ...
      key: 'address',
      render: (text: any, record: any) => {
        return <Normal state={record[1].phase.value ? record[1].phase.value : '-'} />
      },
    },
    {
      title: t('Vote Time'),
      ...
      key: 'blockTime',
      render: (text: any, record: any) => {
        return <TimeStatus content={record[1].indexer.blockTime} />
      },
    },
    {
      ...
      render: (text: any, record: any) => {
        return (
          <LinkX
            linkUrl={`/blockDetails/${record[1].indexer.blockHeight}`}
            state={record[1]}
            content={record[1].indexer.blockHeight}
          />
        )
      },
    },
    {
      ...
      key: 'extrinsic',
      render: (text: any, record: any) => {
        return <Normal state={record[1].data[3] / 10000000 ? record[1].data[3] / 10000000 : '-'} />
      },
    },
  ]
